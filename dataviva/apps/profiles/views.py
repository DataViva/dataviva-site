...
from dataviva.api.rais import models as rais
from dataviva.api.secex import models as secex

from dataviva.api.attrs.models import Search, Bra, Cnae, Cbo, Hs, Wld, University, Course_hedu, Course_sc
from dataviva.api.attrs.models import Ybb, Yii, Yoo, Ypp, Yww, Yuu
from dataviva.api.secex.models import Ymb, Ymp, Ymw
from dataviva.api.rais.models import Ybi, Ybo, Yio, Yi, Yo
...
from dataviva.apps.profiles import models as profileModels
