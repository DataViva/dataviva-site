...
static_folder = '../../static/img/icons/wld'
...
def index():
    ...
    return render_template('trade_partner/index.html', body_class='perfil-estado', header=header, body=body, static_folder=static_folder)
