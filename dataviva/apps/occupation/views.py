...
def index(occupation_id):
    ...
    body['activity_with_biggest_wage_avg'] = rais_occupation_activities_service.activity_with_biggest_wage_average()
    body['activity_with_biggest_wage_avg_value'] = rais_occupation_activities_service.num_jobs_of_activity_with_biggest_wage_average()
