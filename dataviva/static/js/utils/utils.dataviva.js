...
dataviva.format.text = function(text,name,vars,obj,l) {
  ...
  function format_name(name) {
    ...
    var labels = {
      ...
      "crosswalk_hs": {"en": "Common Industries", "pt": "Common Industries"},
      "crosswalk_cnae": {"en": "Common Products", "pt": "Common Products"},
      "crosswalk_cbo": {"en": "Common Majors", "pt": "Common Majors"},
      "crosswalk_course_hedu": {"en": "Common Occupations", "pt": "Common Occupations"},
