...
dataviva.format.text = function(text,name,l) {
  ...
  function format_name(name) {
    ...
    var labels = {
      ...
      "bra_diversity_desc": {"en": "The number of unique municipalities where a given variable is present.", "pt": "O n\u00fdmero de munic\u00edpios \u00fdnicos nos quais uma dada vari\u00e1vel est\u00e1 presente."},
      ...
      "isic_diversity_desc": {"en": "The number of unique 5-digit ISIC industries that are present for a given variable.", "pt": "O n\u00fdmero de atividades \u00fdnicas de 5 d\u00edgitos ISIC que est\u00e3o presentes para uma dada vari\u00e1vel."},
      ...
      "cbo_diversity_desc": {"en": "The number of unique 4-digit CBO occupations that are present for a given variable.", "pt": "O n\u00fdmero de ocupa\u00e7\u00f5es \u00fdnicas de 4 d\u00edgitos CBO que est\u00e3o presentes para uma dada vari\u00e1vel."},
      ...
      "hs_diversity_desc": {"en": "The number of unique HS4 products that are present for a given variable.", "pt": "O n\u00fdmero de produtos \u00fdnicos HS4 que est\u00e3o presentes para uma dada vari\u00e1vel."},
      ...
      "wld_diversity_desc": {"en": "The number of unique import countries that are present for a given variable.", "pt": "O n\u00fdmero de pa\u00edses importadores \u00fdnicos que est\u00e3o presentes para uma dada vari\u00e1vel."},
