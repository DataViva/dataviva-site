...
dataviva.format.text = function(text,name,l) {
  ...
  function format_name(name) {
    ...
    var labels = {
      ...
      "unique_cbo_desc": {"en": "The number of different occupations that are employed in an industry.", "pt": "O n\u00fdmero das diferentes ocupa\u00e7\u00e3es empregadas em um setor."},
      "distance": {"en": "Distance", "pt": "Dist\u00e2ncia"},
      "distance_desc": {"en": "Distance is a measure used to indicate how “far away” any given location is from a particular industry, occupation or product.", "pt": "Dist\u00e2ncia \u00e9 uma medida utilizada para indicar “qu\u00e3o longe” uma localidade específica está de um determinado setor, ocupa\u00e7\u00e3o ou produto."},
      ...
      "required_desc": {"en": "The estimated number of employees per establishment needed in order to have a successful establishment in an industry in a particular location.", "pt": "O n\u00fdmero estimado de empregados por estabelecimento a fim de ser bem sucedido em um setor de uma determinada localidade."},
