$(document).ready(function(){
    ...
    BlueBox.add({
        url: dataviva.api_url + 'hedu/year/hedu_course/?order=entrants&year=2016&direction=desc&limit=1&' + filter,
        title: dictionary['main_course'],
    ...
    BlueBox.add({
        url: dataviva.api_url + 'hedu/year/hedu_course/?order=graduates&year=2016&direction=desc&limit=1&' + filter,
        title: dictionary['main_course'],
