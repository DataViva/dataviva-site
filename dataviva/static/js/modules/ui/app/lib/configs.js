...
export const env = {
  apiUrl: process.env.API_URL ?
    process.env.API_URL : "https://legacy.api.dataviva.info/",
...
export const databases = {
  ...
  occupation: {
    ...
    extraInfo: {
      label: "message.jobs",
      endpoint: "rais/occupation_family/?value=employee&year=2023&order=occupation_family",
  ...
  industry: {
    ...
    extraInfo: {
      label: "message.jobs",
      endpoint: "rais/industry_class/?value=employee&year=2023&order=industry_class",
      id: "industry_class",
      dataValue: "jobs",
    },
