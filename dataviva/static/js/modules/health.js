$(document).ready(function(){
    ...
    General.add({
        url: "http://api.staging.dataviva.info/cnes_bed/year?" + filters,
    ...
    General.add({
        url: "http://api.staging.dataviva.info/cnes_professional/year?" + filters,
    ...
    General.add({
        url: 'http://api.staging.dataviva.info/cnes_professional/year/occupation_family/?order=professionals&direction=desc&limit=1' + filters,
    ...
    General.add({
        url: "http://api.staging.dataviva.info/cnes_equipment/year?" + filters,
    ...
    BlueBox.add({
        url: 'http://api.staging.dataviva.info/cnes_bed/year/bed_type?order=beds&direction=desc&limit=1&' + filters,
        title: dictionary['main_bed_type'],
    ...
    BlueBox.add({
        url: "http://api.staging.dataviva.info/cnes_equipment/equipment_type?" + filters,
        title: dictionary['main_equipment_type'],
        subtitle: dictionary['by_quantity'],
        label: {
            metadata: true,
