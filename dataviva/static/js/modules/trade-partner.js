$(document).ready(function(){
    ...
    BlueBox.add({
        url: 'http://api.staging.dataviva.info/secex/year/product/?order=value&year=2016&direction=desc&limit=1&type=import&' + filter,
        title: dictionary['main_product'],
    ...
    BlueBox.add({
        url: 'http://api.staging.dataviva.info/secex/year/type/product/?year=2016&' + filter,
