$(document).ready(function () {
    ...
    fetch("https://legacyapi.dataviva.info/secex/year").then((data) => {
        data.json().then((data) => {
    ...
    function getData(latestSecexYear) {
        ...
        //BLUEBOXES ADD
        BlueBox.add({
            url: dataviva.api_url + `secex/year/product/?order=value&year=${latestSecexYear}&direction=desc&limit=1&type=export&` + filter,
        ...
        BlueBox.add({
            url: dataviva.api_url + `secex/year/product/?order=value&year=${latestSecexYear}&direction=desc&limit=1&type=import&` + filter,
            title: dictionary['main_product'],
        ...
        BlueBox.add({
            url: dataviva.api_url + `secex/year/type/product/?year=${latestSecexYear}&` + filter,
        ...
        //INDICATORS ADD
        Indicator.add({
            url: dataviva.api_url + `secex/year/type/?year=${latestSecexYear}&` + filter,
