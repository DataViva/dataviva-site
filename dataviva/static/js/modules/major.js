$(document).ready(function(){
    ...
    if(!isMunicipality) {
	    BlueBox.add({
	        url: dataviva.api_url + 'hedu/year/municipality/?order=enrolleds&year=2016&direction=desc&limit=1&' + filter,
	    ...
	    BlueBox.add({
	        url: dataviva.api_url + 'hedu/year/municipality/?order=entrants&year=2016&direction=desc&limit=1&' + filter,
	        title: dictionary['main_municipality'],
	    ...
	    BlueBox.add({
	        url: dataviva.api_url + 'hedu/year/municipality/?order=graduates&year=2016&direction=desc&limit=1&' + filter,
	        title: dictionary['main_municipality'],
    ...
    BlueBox.add({
        url: dataviva.api_url + 'hedu/year/university/?order=entrants&year=2016&direction=desc&limit=1&' + filter,
        title: dictionary['main_university'],
        subtitle: dictionary['number_entrant_students'],
        label: {
            metadata: true,
    ...
    BlueBox.add({
        url: dataviva.api_url + 'hedu/year/university/?order=graduates&year=2016&direction=desc&limit=1&' + filter,
        title: dictionary['main_university'],
        subtitle: dictionary['number_graduates_students'],
        label: {
            metadata: true,
    ...
    //INDICATORS ADD
    Indicator.add({
        url: dataviva.api_url + "hedu/year/?count=enrollments&year=2016&" + filter,
        title: dictionary['number_enrolleds'] + ' (2016)',
        preffix: 'USD',
        value:  'enrolleds'
    });

    Indicator.add({
        url: dataviva.api_url + "hedu/year/?count=entrants&year=2016&" + filter,
        title: dictionary['number_entrants'] + ' (2016)',
        value:  'entrants'
    });

    Indicator.add({
        url: dataviva.api_url + "hedu/year/?count=graduates&year=2016&" + filter,
        title: dictionary['number_graduates'] + ' (2016)',
        value:  'graduates'
    });
