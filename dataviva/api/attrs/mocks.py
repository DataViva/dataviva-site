...
attrs_datasets = [
    DataSet('rais', [locations, industries, occupations], [str(year) for year in range(2002, 2023)]),
    DataSet('secex', [locations, products, trade_partners], [str(year) for year in range(2000, 2020)]),
