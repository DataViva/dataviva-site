...
def crosswalk(attr1, attr2):
    attr_table_map = {"cbo" : Cbo, "course_hedu" : Course_hedu, "hs": Hs, "cnae": Cnae}
    Attr1_Table = attr_table_map[attr1]
    Attr2_Table = attr_table_map[attr2]
